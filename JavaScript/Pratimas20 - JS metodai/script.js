...
// console.log(seconds)
const secondsToShow = seconds + " " + 'seconds';
...
function daysLived (param) {
    console.log(param * 365)
}
daysLived(age)

// -------------------------------3 uzduotis---------------------------------------

const fn = (numb) => numb ** 2;
console.log(fn(10))
...
const fn3 = (name) => name.charAt(name.length - 1);
console.log(fn3('Mantas'))

// -------------------------------6 uzduotis---------------------------------------

const fn4 = (name) => name.split("").reverse().join("").toLowerCase();
console.log(fn4('Mantas'))

// -------------------------------7 uzduotis---------------------------------------
const array = [-5, -2, 5, 14, 28, 34, 60]

function lowestNumb(arr) {
   return arr.filter(x => x < 0).sort((a, b) => b - a)[0];
}

console.log(lowestNumb(array))
...
function rng(param) {
    ...
    for(i = 0; i < param; i++) {
        rngArray.push(Math.floor(Math.random() * 10) + 1)
    }
    return rngArray
}
console.log(rng(8))
...
const returnNumber = (numb1, numb2) => numb1 + numb2 > 100;
console.log(returnNumber(50,51))
...
const fn5 = (array) => array.sort((a, b) => a.name > b.name ? 1 : -1).sort((a, b) => a.age - b.age);
console.log(fn5(array2))
...
function isItHoliday(date) {
  ...
  console.log(isItHoliday(new Date("2023-04-11")))

// -------------------------------12 uzduotis---------------------------------------

const array3 = [1,2,3,5,6,8]
...
console.log(data.filter((obj) => obj.gender === 'Male').length)
